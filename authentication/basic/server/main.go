...
func main() {
	...
	opts := []grpc.ServerOption{
		...
		grpc.UnaryInterceptor(ensureValidBasicCredentials),  // добавляем унарный перехватчик, для обработки аутентификации
	}
...
func valid(authorization []string) bool {
	...
	return token == base64.StdEncoding.EncodeToString([]byte("root:P@$$w0rd"))
}

// ensureValidBasicCredentials перехватчик унарных вызовов
// выполняем проверку аутентификации
func ensureValidBasicCredentials(ctx context.Context, req interface{}, _ *grpc.UnaryServerInfo,
